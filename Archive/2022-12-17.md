...
12:00 w/ Kian, ff, dahoum

* Show ff the model of the labyrinth `done`
* Add one crossing `done`
* How do we stop when we face a wall `HOMEWORK`
* Check all crossings and add the missing `HOMEWORK`
* We moved the move_actor logic into a separate function and into a separate file `done`
